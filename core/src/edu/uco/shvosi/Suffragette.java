...
public class Suffragette extends Antagonist {
    private Animation suffragetteWalk;
        ...
        super.draw(batch, alpha);
            ...
            else
            {
                ...
                if (flip) {
                    ...
                    batch.draw(suffragetteWalk.getKeyFrame(elapsedTime), this.getX(), this.getY(), Constants.TILEDIMENSION, Constants.TILEDIMENSION);
                }
                if (suffragetteWalk.isAnimationFinished(elapsedTime)) {
                    moving = false;
                    elapsedTime = 0f;
                }
