...
//
//        //Some Random Enemies for testing
...
//        entityList.add(new CatLady(TextureLoader.CATLADYTEXTURE, 7, 6));
//        entityList.add(new CatLady(TextureLoader.CATLADYTEXTURE, 7, 7));
...
//    }
    ...
    public void playTurn(Entity entity) {
        Constants.TurnAction action = entity.getTurnAction();
        switch (entity.getGridCode()) {
            case PLAYER:
                //Do Bernard Stuff
