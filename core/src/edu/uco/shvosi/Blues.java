...
public class Blues extends Antagonist {
    ...
    public Blues(int cX, int cY) {
        super(TextureLoader.BLUESTEXTURE, cX, cY);
        this.setEnemyType(Constants.EnemyType.BLUES);
        blueWalk = TextureLoader.blueWalk;
    ...
    public void draw(Batch batch, float alpha) {
        super.draw(batch, alpha);
           ...
           //{
                if (flip) {
                    temp = blueWalk.getKeyFrame(elapsedTime);
                    temp.flip(true, false);
                    batch.draw(temp, this.getX(),getY(), Constants.TILEDIMENSION, Constants.TILEDIMENSION);
                    temp.flip(true, false);
                } else {
                    batch.draw(blueWalk.getKeyFrame(elapsedTime), this.getX(), this.getY(), Constants.TILEDIMENSION , Constants.TILEDIMENSION);
                }
